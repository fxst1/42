...
# define ADDRPTR_COLOR_GC "\033[38;5;22m"
...
# define SIZE_FORMAT_GC SIZE_COLOR_GC " %zu\033[0m"
# define MASK_FORMAT_GC MASK_COLOR_GC " %x\033[0m"
# define INDEX_PRINT_GC INDEX_COLOR_GC " Index\033[0m"
# define ADDRPTR_PRINT_GC ADDRPTR_COLOR_GC " Address pointer\033[0m"
# define ADDRCNT_PRINT_GC ADDRCNT_COLOR_GC " Address content\033[0m"
# define ADDREND_PRINT_GC ADDREND_COLOR_GC " Address end content\033[0m"
# define SIZE_PRINT_GC SIZE_COLOR_GC " Alloc size\033[0m"
# define MASK_PRINT_GC MASK_COLOR_GC " Mask\033[0m"
...
# define CATEGORIES_FORMAT_GC INDEX_FORMAT_GC SEPARATOR_GC ADDRPTR_FORMAT_GC SEPARATOR_GC ADDRCNT_FORMAT_GC SEPARATOR_GC ADDREND_FORMAT_GC SEPARATOR_GC SIZE_FORMAT_GC SEPARATOR_GC MASK_FORMAT_GC "\033[0m\n"
